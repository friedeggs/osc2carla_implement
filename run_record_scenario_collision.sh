#!/bin/bash -l
# Boot CARLA, compile & run scenario_collision.osc, record MP4.
set -u
...
LOG="${AV_INSTALL}/carla_server_scenario_collision.log"
PORT="${AV_PORT}"
OUT_DIR="${AV_RUN}/scenario_collision"
SCENARIO="${OSC2CARLA_ROOT}/scenarios/scenario_collision.osc"
VIDEO="${OUT_DIR}/scenario_collision.mp4"
...
echo "[step] recording scenario_collision.osc (~22 s, ego camera)"
