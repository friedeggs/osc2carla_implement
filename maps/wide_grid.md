...
4x4 junctions covering x,y in [-80, 160]. Four four-way junctions -- (0,0), (0,80), (80,0), (80,80) -- each with 66 m of straight approach on every arm. The one to stage junction conflicts in.
...
|---|---|---|
| (-80, -80) | `ES` | `position(x: -80.00, y: -80.00, z: -0.40, at: start)` |
| (-80, 0) | `NES` | `position(x: -80.00, y: 0.00, z: -0.40, at: start)` |
| (-80, 80) | `NES` | `position(x: -80.00, y: 80.00, z: -0.40, at: start)` |
| (-80, 160) | `NE` | `position(x: -80.00, y: 160.00, z: -0.40, at: start)` |
| (0, -80) | `ESW` | `position(x: 0.00, y: -80.00, z: -0.40, at: start)` |
| (0, 0) | `NESW` | `position(x: 0.00, y: 0.00, z: -0.40, at: start)` |
| (0, 80) | `NESW` | `position(x: 0.00, y: 80.00, z: -0.40, at: start)` |
| (0, 160) | `NEW` | `position(x: 0.00, y: 160.00, z: -0.40, at: start)` |
| (80, -80) | `ESW` | `position(x: 80.00, y: -80.00, z: -0.40, at: start)` |
| (80, 0) | `NESW` | `position(x: 80.00, y: 0.00, z: -0.40, at: start)` |
| (80, 80) | `NESW` | `position(x: 80.00, y: 80.00, z: -0.40, at: start)` |
| (80, 160) | `NEW` | `position(x: 80.00, y: 160.00, z: -0.40, at: start)` |
| (160, -80) | `SW` | `position(x: 160.00, y: -80.00, z: -0.40, at: start)` |
| (160, 0) | `NSW` | `position(x: 160.00, y: 0.00, z: -0.40, at: start)` |
