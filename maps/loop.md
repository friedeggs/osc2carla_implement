...
|---|---|---|---|---|---|
| x | y = -5.25 | west (-x) | +2 | +3.1416 | x in [7, 233] |
| x | y = -1.75 | west (-x) | +1 | +3.1416 | x in [7, 233] |
| x | y = 1.75 | east (+x) | -1 | +0.0000 | x in [7, 233] |
| x | y = 5.25 | east (+x) | -2 | +0.0000 | x in [7, 233] |
| x | y = 134.75 | west (-x) | +2 | +3.1416 | x in [7, 233] |
| x | y = 138.25 | west (-x) | +1 | +3.1416 | x in [7, 233] |
| x | y = 141.75 | east (+x) | -1 | +0.0000 | x in [7, 233] |
| x | y = 145.25 | east (+x) | -2 | +0.0000 | x in [7, 233] |
| y | x = -5.25 | south (+y) | -2 | +1.5708 | y in [7, 133] |
| y | x = -1.75 | south (+y) | -1 | +1.5708 | y in [7, 133] |
| y | x = 1.75 | north (-y) | +1 | -1.5708 | y in [7, 133] |
| y | x = 5.25 | north (-y) | +2 | -1.5708 | y in [7, 133] |
| y | x = 234.75 | south (+y) | -2 | +1.5708 | y in [7, 133] |
| y | x = 238.25 | south (+y) | -1 | +1.5708 | y in [7, 133] |
| y | x = 241.75 | north (-y) | +1 | -1.5708 | y in [7, 133] |
| y | x = 245.25 | north (-y) | +2 | -1.5708 | y in [7, 133] |
